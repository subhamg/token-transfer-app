...
export const WalletDetail = ({ balance, address, usdcBalance, refreshBalance, transferETH, transferERC20 }: IProps) => {
  return (
    <div className='flex items-center justify-center flex-col gap-4'>
      ...
      <div className='flex flex-col mt-4 gap-y-4'>
        ...
        <div className='flex items-center gap-x-4 mt-4'>
          ...
          <Button color='blue' variant='filled' size='xs' className='bg-blue-500 hover:bg-blue-600 font-medium' onClick={transferERC20} leftIcon={<Image src='usdc.svg' alt='Eth' width={16} height={16} />}>Transfer ERC-20 Tokens</Button>
        </div>
      </div>
